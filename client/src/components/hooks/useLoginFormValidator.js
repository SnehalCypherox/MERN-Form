...
import { emailValidator, userNameValidator, mobileValidator, passwordValidator, confirmPasswordValidator,} from "../Form/validators";
...
export const useLoginFormValidator = form => {
  ...
  const validateForm = ({ form, field, errors, forceTouchErrors = false }) => {
    ...
    const { email, userName, mobile, password, confirmPassword } = form;
